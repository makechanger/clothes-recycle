...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '回收员扩展信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of collector
-- ----------------------------
INSERT INTO `collector` VALUES (6, 2, '李四', '/uploads/fd585f1897b14766ab2ba4dbbba86574.png', 2, '2026-05-20 14:14:18', '2026-05-20 14:14:18');
INSERT INTO `collector` VALUES (8, 3, '王磊', '/uploads/5923d8bcaaf44db6ae92d130aaaa3b16.png', 2, '2026-05-20 14:25:44', '2026-05-20 14:25:44');
INSERT INTO `collector` VALUES (9, 6, '刘贵', '/uploads/1c095dda86414e70a7ff64d798570fbb.png', 2, '2026-05-20 14:25:55', '2026-05-20 14:25:55');
...
CREATE TABLE `role_application`  (
  ...
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '角色申请表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of role_application
-- ----------------------------
INSERT INTO `role_application` VALUES (17, 2, 'COLLECTOR', '李四', '/uploads/fd585f1897b14766ab2ba4dbbba86574.png', NULL, NULL, NULL, 1, NULL, '2026-05-20 14:09:24', '2026-05-20 14:09:24');
INSERT INTO `role_application` VALUES (18, 1, 'COLLECTOR', '张三', '/uploads/99931e12befc4b678b971bb87710fc6a.png', NULL, NULL, NULL, 1, NULL, '2026-05-20 14:10:12', '2026-05-20 14:10:12');
INSERT INTO `role_application` VALUES (19, 3, 'COLLECTOR', '王磊', '/uploads/5923d8bcaaf44db6ae92d130aaaa3b16.png', NULL, NULL, NULL, 1, NULL, '2026-05-20 14:10:42', '2026-05-20 14:10:42');
INSERT INTO `role_application` VALUES (20, 4, 'COLLECTOR', '赵敏', '/uploads/8c0a3a82456a403aa62ed210af8b78fc.png', NULL, NULL, NULL, 0, NULL, '2026-05-20 14:11:09', '2026-05-20 14:11:09');
INSERT INTO `role_application` VALUES (21, 6, 'COLLECTOR', '刘贵', '/uploads/1c095dda86414e70a7ff64d798570fbb.png', NULL, NULL, NULL, 1, NULL, '2026-05-20 14:11:52', '2026-05-20 14:11:52');
INSERT INTO `role_application` VALUES (22, 7, 'COLLECTOR', '孙思同', '/uploads/9b7c67b00b884b35880eb3cbeebe4207.png', NULL, NULL, NULL, 2, '名称不符', '2026-05-20 14:12:29', '2026-05-20 14:12:29');
INSERT INTO `role_application` VALUES (23, 10, 'COLLECTOR', '郑伟', '/uploads/9258dc76f5d24855977df53d2d882c07.png', NULL, NULL, NULL, 0, NULL, '2026-05-20 14:13:59', '2026-05-20 14:13:59');
...
INSERT INTO `user` VALUES (2, '13800000002', '$2a$10$GxV/zz1Bx1Amn.LUGa2usu2FbFMTDni7EO6O4NKhGOJP8wpNIjOB.', '李四', 'COLLECTOR', 40, 1, '2026-05-02 17:03:14', '2026-05-02 17:03:15');
...
INSERT INTO `user` VALUES (4, '13800000004', '$2a$10$GxV/zz1Bx1Amn.LUGa2usu2FbFMTDni7EO6O4NKhGOJP8wpNIjOB.', '赵敏', 'USER', 0, 1, '2026-05-02 17:03:14', '2026-05-02 17:03:14');
...
INSERT INTO `user` VALUES (7, '13800000007', '$2a$10$GxV/zz1Bx1Amn.LUGa2usu2FbFMTDni7EO6O4NKhGOJP8wpNIjOB.', '孙思通', 'USER', 0, 1, '2026-05-02 17:03:14', '2026-05-02 17:03:14');
